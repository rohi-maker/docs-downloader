...
import com.docsDownloaderProject.config.FeignErrorDecoder;
...
@FeignClient(name = "docs-api", url = "https://docs.googleapis.com/v1",configuration = {FeignErrorDecoder.class})
